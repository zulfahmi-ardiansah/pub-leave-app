                        ...
                        <div class="card-body">
                            <form action="" method="GET">
                                <div class="input-group">
                                    <input value="{{ isset($_GET['started_at']) ? $_GET['started_at'] : '' }}" type="date" name="started_at" class="form-control">
                                    <button disabled="true" class="btn">
                                        Sampai Dengan
                                    </button>
                                    <input value="{{ isset($_GET['ended_at']) ? $_GET['ended_at'] : '' }}" type="date" name="ended_at" class="form-control">
